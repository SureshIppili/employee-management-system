...
public class employeeController {
    @Autowired
    private employeeManagement.employeemanagementsystem.service.employeeService employeeService;
    ...
    public ResponseEntity<employeeManagement.employeemanagementsystem.entity.Employee> createEmployee(@Validated @RequestBody employeeManagement.employeemanagementsystem.entity.Employee employee) {
        employeeManagement.employeemanagementsystem.entity.Employee savedEmployee = employeeService.saveEmployee(employee);
